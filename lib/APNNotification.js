 ...
 * @param {Object} notification Configuration for the notification
 * @returns {Notification}
 * @private
 */
APNNotification.prototype._createNotification = function (notification) {
  return new apn.Notification(notification);
};
 ...
 * @param {Object} [_notificationConfig] Additional configuration for notification
 * @returns {APNNotification}
 * @example
 ...
 * });
 */
APNNotification.prototype.send = function (_device, _notification, _notificationConfig) {
  var device = _device || [];
  var notification = this._createNotification(_.merge({}, this.getConfig('notification'), {
    aps: {
      alert: {
        title: _notification.title,
        body: _notification.body
      },
      sound: _notification.sound,
      badge: _notification.badge
    },
    payload: _notification.payload
  }, _notificationConfig));
